...
def train(msg: Message, context: Context) -> Message:
    ...
    # 3. SAFETY CHECK: Skip training if client has 0 data
    ...
    # 4. NORMAL TRAINING (Only executed if train_loader exists)
...
def evaluate(msg: Message, context: Context) -> Message:
    ...
    if val_loader is None:
        ...
        return Message(content=out_payload, reply_to=msg)
    # 4. Evaluate the model locally  NORMAL EVALUATION (Only if val_loader exists)
    criterion = torch.nn.CrossEntropyLoss()
